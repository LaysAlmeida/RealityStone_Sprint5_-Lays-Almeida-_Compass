...
COMO um usuário do E-commerce AdvantagesOnlineShopping
...
#Vai ler <produto> e começar a ler cada linha da execução
# Primeira execução: Speakers
# Segunda execução: Tablets
# Terceira execução: Laptops
# Quarta execução: Mice
# Quinta execução: Headphones
